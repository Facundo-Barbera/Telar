...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        // `bg-overlay`, not `bg-black/10`: black is a colour no palette here
        // owns, so the scrim laid a cold grey film over a warm canvas and said
        // the same thing in both schemes when the two need opposite ends of
        // the theme. The token carries its own alpha — see globals.css.
