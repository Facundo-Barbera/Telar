  ...
  return (
    <header
      className={cn(
         ...
         */
        // The same shortened band as the rail's header and the session masthead
        // (both islands start --app-island-inset down and the lights do not
        // move), so every header sitting beside the rail reads at one height.
