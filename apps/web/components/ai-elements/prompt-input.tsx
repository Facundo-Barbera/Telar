...
// This project's menu primitives pass a Base UI synthetic event, not a raw
// Event — derive the type so the handlers match whichever library is installed.
type ItemSelectEvent = Parameters<
