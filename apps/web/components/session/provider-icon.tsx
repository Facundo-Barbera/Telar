...
// just for two logos. Claude: Anthropic's mark (via simple-icons, brand
// #D97757). Codex: OpenAI Codex mark (via @lobehub/icons), tinted to the
// current text colour so it reads in both themes.
const CLAUDE_D =
