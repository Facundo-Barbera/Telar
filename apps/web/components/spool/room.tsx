      ...
      {tab === "tasks" && (
        <div className="mb-3 flex flex-wrap items-center gap-1.5">
          <button
            ...
            className={cn(
              "rounded-full border px-2 py-0.5 text-[0.6875rem] transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring",
          ...
          {tagsInData.map((tag) => (
            <button
              ...
              className={cn(
                "rounded-full border px-2 py-0.5 font-mono text-[0.625rem] transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring",
          ...
          {filterOn && (
            <button
              type="button"
              onClick={() => setFilter({})}
              className="ml-1 rounded-sm text-[0.6875rem] text-muted-foreground/70 underline decoration-dotted transition-colors outline-none hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring"
            >
              clear ✕
            </button>
          )}
