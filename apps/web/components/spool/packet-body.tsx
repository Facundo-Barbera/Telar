...
export function SectionLabel({ children }: { children: ReactNode }) {
  return <h2 className="mb-2 text-[11px] font-medium tracking-[0.12em] text-muted-foreground/80 uppercase">{children}</h2>;
}
  ...
  return (
    <div className="space-y-2 border-t border-border/70 pt-3">
      ...
      {(refusal ?? (settled && settled.state !== "done" ? settled.note : null)) && (
        <p className="rounded-lg bg-muted/60 px-2 py-1.5 text-[11px] leading-relaxed text-muted-foreground">
