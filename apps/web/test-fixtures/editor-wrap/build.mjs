/**
 * Bundle the editor-wrap fixture into the shared fixture dir (it reuses that
 * build's compiled app.css).
 * Run: bun apps/web/test-fixtures/editor-wrap/build.mjs
 */
...
const page = "editor-wrap.html";
const script = "/editor-wrap.js";
fs.writeFileSync(
  resolve(out, page),
  `<!doctype html>
<html class="dark"><head><meta charset="utf-8"><title>Editor wrap fixture</title>
