...
const CAPTION = "text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/70";
  ...
  return (
    ...
    >
      ...
      <span className="shrink-0">
        {ghost ? <span className="text-[11px] not-italic text-muted-foreground">planned</span> : <ThreadStatusSlot live={live} />}
      </span>
    </button>
  );
}
